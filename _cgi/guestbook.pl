...
$guestbookurl = "/Contact_Us/guest_book.html";
$guestbookreal = $ENV{'DOCUMENT_ROOT'} . "/Contact_Us/guest_book.html";
$guestlog = $ENV{'DOCUMENT_ROOT'} . "/Contact_Us/guest_log.html";
$cgiurl = "/cgi-bin/guestbook.pl";
...
for ($i=0;$i<=$SIZE;$i++) {
   ...
   if (/<!--begin-->/) { 
      ...
      if ($separator eq '1') {
         print GUEST " - $date<hr WIDTH=80%></FONT>\n\n";
      }
      else {
         print GUEST " - $date<p></FONT>\n\n";
      }
...
sub no_comments {
   ...
   print "<html><head><title>Please fill in your comments</title></head>\n";
   print "<body><h2>Please fill in your comments for $ENV{'SERVER_NAME'}\'s guestbook</h2>\n";
   print "<form method=POST action=\"$cgiurl\">\n";
   print "<PRE>\n";
   print "Your Name:<input type=text name=\"realname\" size=41 ";
   print "value=\"$FORM{'realname'}\">\n";
   print "   E-Mail:<input type=text name=\"username\""; 
   print "value=\"$FORM{'username'}\" size=41>\n";
   print "     City:<input type=text name=\"city\" value=\"$FORM{'city'}\" ";
   print "size=15> State: <input type=text name=\"state\" "; 
   print "value=\"$FORM{'state'}\" size=15> \n  Country:<input type=text "; 
   print "name=\"country\" value=\"$FORM{'country'}\" size=15>\n";
   print "</PRE>\n";
   print "Comments:<br>\n";
   print "<textarea name=\"comments\" COLS=60 ROWS=4></textarea><p>\n";
   print "<input type=submit VALUE=Send> * <input type=reset></form><hr>\n";
