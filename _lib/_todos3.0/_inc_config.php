...
*/
include_once($doc_root."/_include/todosConfig.php");<p>define("SITE_PATH_ROOT", 	$doc_root);
// e.g. "/www/servers/AoM/www"<p>define("TODOS_ROOT", 		'/_todos3');
...
// darn.
define("MySQLVer",		"4.15");<p>define("IDX3_CLASS_TABLES",	0);		## Turn on/off use of the idx3_<class> tables
						## Still in development<p>#define("DEBUG", 0);
define("DEBUG", 1);<p>if(! $DB_SOFTWARE){ // Only set if not set in site specific config file
	...
	$DB_ACCOUNT         =	"AOM";
	$DB_PASSWORD        =	'';
	$DB_DATABASE        =	'todosAoM';<p>     ## Login database
	//$DBL_SOFTWARE  = 	"mysql";
	$DBL_LOCATION        = 	"localhost";
	$DBL_ACCOUNT         =	"AOM";
	$DBL_PASSWORD        =	'';
	$DBL_DATABASE        =	'todosAoM';
}<p>function configReport(){
//
